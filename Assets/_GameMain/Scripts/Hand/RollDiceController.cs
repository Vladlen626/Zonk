...
public class RollDiceController : NetworkBehaviour
{
    ...
    private readonly Vector2 ROLL_OFFSET = new Vector2(-0.020f, 0.020f);
    ...
    public void Roll()
    {
        for (var diceNum = 0; diceNum < rollDices.Count; diceNum++)
        {
            ...
            var randomOffset = new Vector3(Random.Range(ROLL_OFFSET.x, ROLL_OFFSET.y), 0, Random.Range(ROLL_OFFSET.x, ROLL_OFFSET.y));
